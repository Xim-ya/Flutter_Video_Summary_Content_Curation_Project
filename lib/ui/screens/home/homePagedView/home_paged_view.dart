...
class HomePagedView extends BaseView<HomePagedViewModel> {
  const HomePagedView({Key? key}) : super(key: key);

  @override
  Widget buildView(BuildContext context) {
    final screenList = [
      HomeScreen(routeAction: vm.pagedRouteHandler),
      Obx(
        () => vm.screenIndex == 1
            ? HomeContentDetailScreen(routeAction: vm.pagedRouteHandler)
            : const SizedBox(),
      )
    ];
