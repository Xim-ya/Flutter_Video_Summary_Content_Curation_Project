...
final double groupButtonTextSize = 10.55.sp; // 36px (ipad 12.9)
final double groupButtonH = 14.5.sp;
final double groupButtonRP = 2.2.w; // 22px (ipad 12.9)
final double contentResponsiveW = 66.25.w; // 22px (ipad 12.9)
final double contentResponsiveH = 21.7.h; // 296px (ipad 12.9)
final double contentSliderDivideP =
    7.9.h; // 148px (ipad 12.9) //TODO 디테일은 나중에 결정 (수정필요)
